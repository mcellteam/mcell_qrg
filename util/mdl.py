...
class MdlLexer(CLexer):
    ...
    tokens = {
        'statements': [
            (words((
                "OBJECT", "ITERATIONS", "TIME_STEP", "ABS", "ABSORPTIVE",
                ...
                "BRIEF", "CEIL", "CELLBLENDER", "CENTER_MOLECULES_ON_GRID",
                "CHARGE", "CHECKPOINT_INFILE", "CHECKPOINT_OUTFILE",
                ...
                "REFERENCE_STATE", "REFLECTIVE", "REGION_DATA", "RELEASE_EVENT_REPORT",
                ...
                "TRAIN_DURATION", "TRAIN_INTERVAL", "TRANSFORM", "TRANSPARENT",
                "TRANSLATE", "TRIGGER", "TRUE", "UNLIMITED",
                "VACANCY_SEARCH_DISTANCE", "USELESS_VOLUME_ORIENTATION",
                "VERTEX_LIST", "VIZ_DATA_OUTPUT", "VIZ_OUTPUT", "VIZ_VALUE",
                "VOLUME_DEPENDENT_RELEASE_NUMBER", "VOXEL_IMAGE_MODE",
                "VOXEL_LIST", "VOXEL_VOLUME_MODE", "WARNING", "WARNINGS",
                "WORLD", "YES"), suffix=r'\b'),
             Keyword),
            (r"[,';+-/=@]", Operator),
            inherit,
        ],
